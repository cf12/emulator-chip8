...
#define EXTRACT_NNN uint16_t addr = opcode & 0x0FFF;

#define EXTRACT_KK uint8_t byte = opcode & 0x00FF;
...
void Chip8::OP_NULL() { fprintf(stderr, "OP_NULL: %08x\n", opcode); }

// 00E0 - CLS
void Chip8::OP_00E0() { fill(begin(video), end(video), 0); }
